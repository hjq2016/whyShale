...
(
    ...
    `updated_date` datetime      NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间',
    `is_deleted`   varchar(1)    NOT NULL DEFAULT '0' COMMENT '是否逻辑删除 0-正常 1-删除',
    `author_id`    bigint(11) DEFAULT NULL COMMENT 'sys_user',
    `title`        varchar(1024) NOT NULL COMMENT '标题',
    `content`      varchar(2048)          DEFAULT NULL COMMENT '提问内容',
    PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

CREATE TABLE `page_basic`
(
    `id`           bigint(36) unsigned NOT NULL AUTO_INCREMENT COMMENT '主键',
    `created_by`   varchar(64)            DEFAULT NULL COMMENT '创建者',
    `created_date` datetime      NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
    ...
    `author_id`    bigint(11) DEFAULT NULL COMMENT 'sys_user',
    `title`        varchar(1024) NOT NULL COMMENT '标题',
    `content`      varchar(2048)          DEFAULT NULL COMMENT '文章内容',
    PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;



INSERT INTO `whyshare`.`sys_role`(`id`, `created_by`, `creatd_date`, `updated_by`, `updated_date`, `is_deleted`,
                                  `role_code`, `role_name`)
VALUES (1, 'SYS', '2021-06-10 11:16:06', 'SYS', '2021-06-10 11:16:06', '0', 'admin', '管理员');
INSERT INTO `whyshare`.`sys_role`(`id`, `created_by`, `creatd_date`, `updated_by`, `updated_date`, `is_deleted`,
                                  `role_code`, `role_name`)
VALUES (2, 'SYS', '2021-06-10 11:16:27', 'SYS', '2021-06-10 11:16:27', '0', 'user', '登录用户');
INSERT INTO `whyshare`.`sys_role`(`id`, `created_by`, `creatd_date`, `updated_by`, `updated_date`, `is_deleted`,
                                  `role_code`, `role_name`)
VALUES (3, 'SYS', '2021-06-10 11:16:58', 'SYS', '2021-06-10 11:16:58', '0', 'anonymous', '匿名访问用户');