...
public final class JacksonUtils {
     ...
     * @param obj obj
     * @return json string
     * @throws BusinessException if transfer failed
     */
    public static String toJson(Object obj) {
        try {
            return mapper.writeValueAsString(obj);
        } catch (JsonProcessingException e) {
            throw new BusinessException(obj.getClass(), e);
        }
    }
     ...
     * @return object
     * @throws BusinessException if deserialize failed
     */
    public static <T> T toObj(byte[] json, Class<T> cls) {
        try {
            return toObj(StringUtils.newStringForUtf8(json), cls);
        } catch (Exception e) {
            throw new BusinessException(cls, e);
        }
    }
    ...
    public static <T> T toObj(String json, TypeReference<T> typeReference) {
        try {
            ...
            throw new BusinessException(typeReference.getClass(), e);
        }
    }
    ...
    public static <T> T toObj(InputStream inputStream, Type type) {
        try {
            ...
            throw new BusinessException(type, e);
        }
    }
